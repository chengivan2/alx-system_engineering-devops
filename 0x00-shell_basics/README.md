The 0-currrent_working_directory script prints the absolute path name of the current working directory.
...
The 7-movethatfile script moves the file "/tmp/betty" to the directory "/tmp/myfirstdirectory/".
